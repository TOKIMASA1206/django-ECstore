# Generated by Django 4.2.16 on 2024-09-15 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='', upload_to='upload_image_to')),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='images', to='base.item')),
            ],
        ),
        migrations.AddField(
            model_name='user',
